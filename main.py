...
plt.savefig( "results/ERPGamma.png", dpi=500 )
plt.show()
...
plt.savefig( "results/ERPRiskyGamma.png", dpi=500 )
plt.show()
...
data.to_csv("results/corrmat.csv")
...
plt.ylabel("R in (%)")
plt.savefig("results/reinte.png", dpi=500)
plt.show()
...
plt.ylabel("$")
plt.savefig("results/cumprodREINTE.png", dpi=500)
plt.show()
...
plt.savefig("results/inflation.png", dpi=500)
plt.show()

plt.figure(7)
(df["Dividend"]+df["SP500"]).plot()
plt.title("Nominal S&P 500")
plt.savefig("results/sp500nom.png", dpi=500)
plt.ylabel("Price")
plt.show()
...
plt.savefig("results/nomIR.png", dpi=500)
plt.show()
...
plt.savefig("results/CPI.png", dpi=500)
plt.show()
...
plt.savefig("results/nomConsumption.png", dpi=500)
plt.show()
